...
<div class="container mt-5">
    ...
    <div class="card border-success shadow-lg">
        <div class="card-header bg-success text-white">
            <h2 class="h5 mb-0">✨ ข้อมูลที่ส่งมาเรียบร้อยแล้ว</h2>
        </div>
        <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><strong>ชื่อ-นามสกุล:</strong> <?php echo $fullname; ?></li>
                <li class="list-group-item"><strong>เบอร์โทร:</strong> <?php echo $phone; ?></li>
                <li class="list-group-item"><strong>ส่วนสูง:</strong> <?php echo $height." ซม."; ?></li>
                <li class="list-group-item"><strong>ที่อยู่:</strong> <br><?php echo nl2br($address); ?></li>
                <li class="list-group-item"><strong>วันเดือนปีเกิด:</strong> <?php echo $birthday; ?></li>
                <li class="list-group-item">
                    <strong>สีที่ชอบ:</strong> 
                    <div class="d-flex align-items-center">
                        <div class="color-display" style="background-color:<?php echo $color; ?>; width: 50px; height: 20px; margin-right: 10px;"></div>
                        <?php echo $color; ?>
                    </div>
                </li>
