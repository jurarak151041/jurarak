...
<?php
    if (isset($_POST['Submit'])) {
        ...
        $sql = "INSERT INTO application (a_position, a_prefix, a_fullname, a_birthday, a_education, a_skills, a_experience) VALUES ('{$position}','{$prefix}' ,'{$fullname}','{$birthday}','{$education}','{$skills}','{$experience}');";        
